      ...
      <body class={tw`m-x-50 m-y-0 pt-4 mx-auto max-w-screen-lg bg-blue-50`}>
        ...
        <footer class={tw`m-3 p-2 border bg-green-50`}>
          ...
          <div class={tw`flex flex-row justify-between`}>
            ...
            <div class={tw`flex flex-row text-sm text-right`}>Coded in <a class={tw`ml-1`}href="https://fresh.deno.dev"> FRESH</a><img class={tw`w-6 h-6`} src="/img/fresh_logo.svg"/></div>
          </div>
        </footer>
      </body>
    </html>
